                ...
                <div className="row gap-sm-0">
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    ...
                    <ul className="list-unstyled">
                        <FooterItem desc="About Us"/>
                        <FooterItem desc="Press Release"/>
                        <FooterItem desc="Terms of Use"/>
                        <FooterItem desc="Privacy & Policy"/>
                    </ul>
                  </div>
                  <div className="col-md-4 col-6 mb-lg-0 mb-25">
                    <p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
                    <ul className="list-unstyled">
                        <FooterItem desc="Refund Policy"/>
                        <FooterItem desc="Unlock Rewards"/>
                        <FooterItem desc="Live Chatting"/>
                    </ul>
                  </div>
                  <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                    <p className="text-lg fw-semibold color-palette-1 mb-12">Connect</p>
                    <ul className="list-unstyled">
                        <FooterItem desc="hi@store.gg" link="mailto: hi@store.gg"/>
                        <FooterItem desc="team@store.gg" link="team@store.gg"/>
                        <FooterItem desc="Pasific
                          12,
                          Jakarta Selatan" link="http://maps.google.com/?q=Pasific 12,
                          Jakarta Selatan"/>
                        <FooterItem desc="021 - 1122 -
                          9090" link="tel: 02111229090"/>
                    </ul>
                  </div>
                </div>
              </div>
